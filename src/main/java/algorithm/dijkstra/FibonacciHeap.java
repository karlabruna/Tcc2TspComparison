...
/***********************************************************************
 * File: solver.FibonacciHeap.java
...
public final class FibonacciHeap<T> {
   ...
   * @return A new solver.FibonacciHeap containing all of the elements of both
   *         heaps.
   */
  public static <T> FibonacciHeap<T> merge(FibonacciHeap<T> one, FibonacciHeap<T> two) {
    /* Create a new solver.FibonacciHeap to hold the result. */
